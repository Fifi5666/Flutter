...
class _JoinScreenState extends State<JoinScreen> {
  ...
  final config = CalendarDatePicker2Config(
    ...
    selectableDayPredicate: (day) => !day
        .difference(DateTime.now().subtract(const Duration(days: 3))) // 3 : 오늘부터 3일 전
        .isNegative,
  );
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  value: _idType,
                  items: ["주민등록증", "운정면허증", "여권"].map((String value) {
                  ...
                  onChanged: (value) {
                    setState(() {
                      _idType = value!;   // 변수! : null 아님 명시, 널이 될 수 없다고 ! 찍어주기
                    });
                  }
                ),
                const SizedBox(height: 20.0,),
